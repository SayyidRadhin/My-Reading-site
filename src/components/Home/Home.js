...
function Home() {
  ...
  const [userChek, setuserChek] = useState(false)
  const{userData,currentUser,Article}= useContext(ArticleContext)

  const navigate = useNavigate()

  const slidbarClass = ["slidebar"];
  const slidbarBack = ["slidbar-back-transition"];
  if (Classname === true) {
    slidbarClass.push("slidebar-Toggle");
    slidbarBack.push("slidbar-back");
  } else {
    slidbarBack.push("slidbar-close-effect");
  }

  function currentUserChek () {
    if (currentUser === "") {
      navigate("/login")
    }else{
      navigate("/addarticle")
  ...
  return (
    <>
      <div className="main">
        <div className={slidbarBack.join(" ")}>
          <div className={slidbarClass.join(" ")}>
              <div onClick={()=> setClassname(false)} className="slidbar-svg-wrapper">
                <div className="slidbar-svg"></div>
              </div>
            ...
            <div className="logout-button">
              <button className="Add-button">logout</button>
            </div>
          </div>
        </div>
        ...
        <div className="header">
          ...
          <div className="form-group-add">
            ...
            <button className="Add-button animation-zoom" onClick={currentUserChek} > Add</button>
